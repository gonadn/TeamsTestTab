...
export interface ITeamsTabAppTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITeamsTabAppTabRemoveProps {

}

/**
 * Implementation of TeamsTabApp Tab remove page
 */
export class TeamsTabAppTabRemove  extends TeamsBaseComponent<ITeamsTabAppTabRemoveProps, ITeamsTabAppTabRemoveState> {
